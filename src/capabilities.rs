...
pub struct Capabilities {
    ...
    /// Server flags from PROTOCOL negotiation
    pub server_flags: u8,
    /// Raw server compile-time capabilities (for data_types adjustments)
    pub server_compile_caps: Option<Vec<u8>>,
    /// Raw server runtime capabilities (for data_types adjustments)
