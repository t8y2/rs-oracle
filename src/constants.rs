...
/// Data flags (bytes 8-9 of DATA packet header, immediately before payload)
#[allow(missing_docs)]
pub mod data_flags {
...
pub enum FunctionCode {
    /// Get database version (go-ora compat for 10g)
    DbVersion = 59,
...
pub mod version {
    ...
    /// Minimum accepted version (Oracle 10g R1)
    pub const MIN_ACCEPTED: u16 = 311;
...
pub mod verifier_type {
    pub const V10G: u32 = 0x3975;
    pub const V10G_2361: u32 = 2361;
...
pub mod ccap_value {
    ...
    pub const FIELD_VERSION_10_1: u8 = 4;
    pub const FIELD_VERSION_10_2: u8 = 5;
...
pub mod error_code {
    ...
    pub const END_OF_FILE_ON_COMM: u32 = 3113;
    pub const CONNECTION_LOST_CONTACT: u32 = 3135;
    pub const SESSION_KILLED: u32 = 28;

    // Constraint / lock errors
    pub const UNIQUE_VIOLATION: u32 = 1;
    pub const DEADLOCK: u32 = 60;
    pub const LOCK_TIMEOUT: u32 = 4021;

    // Syntax / parsing errors
    pub const INVALID_SQL_STATEMENT: u32 = 900;
    pub const QUOTED_STRING_NOT_TERMINATED: u32 = 1756;

    // Privilege / object errors
    pub const INSUFFICIENT_PRIVILEGES: u32 = 1031;
    pub const TABLE_OR_VIEW_NOT_FOUND: u32 = 942;
    pub const SEQUENCE_NOT_FOUND: u32 = 2289;
}
